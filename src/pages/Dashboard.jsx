  ...
  return (
    <main>
      ...
      <div id = "dash">
        ...
        <h3 className = "modules">Upcoming Shift
          {upcomingShift && (
      <p className ="info">{(upcomingShift.start).toLocaleDateString('en-US', DATE_OPTIONS)}
      </p>)}
      </h3>
        <h4 className = "modules">Alerts
        <p className ="info">alerts imported here</p></h4>
        <h4 className = "modules">Available Shifts
        <p className ="info">List of Available shifts</p></h4>
        <hr />
      </div>
